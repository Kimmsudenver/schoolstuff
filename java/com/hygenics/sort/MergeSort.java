...
/**
 * Calls the Java Merge Sort. In here just as another option. Merge
 * sort surpasses quick sort in performance after an array reaches a large size.
 * 
 * Why remake it?
 * @author aevens
 *
...
public class MergeSort<E>{
	...
	private ArrayList<E> sort(){
		...
		if(tosortlist.size()<1)
		{
			...
			List<Integer> list=(List<Integer>)tosortlist.subList(0,(tosortlist.size()-1));
			...
			List<Double> list=(List<Double>)tosortlist.subList(0,(tosortlist.size()-1));
		...
		{
			List<Float> list=(List<Float>)tosortlist.subList(0,(tosortlist.size()-1));
			...
			List<Character> list=(List<Character>)tosortlist.subList(0,(tosortlist.size()-1));
			...
			List<String> list=(List<String>)tosortlist.subList(0,(tosortlist.size()-1));
