...
/**
 * Execuutes a process using process builder.
 * Takes in a map with the process name and what should be either a one argument string or string like array to processed (1 parameter only)
 * @author aevens
 *
 */
