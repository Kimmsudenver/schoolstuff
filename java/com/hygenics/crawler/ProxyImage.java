...
/**
 * Store an image loaded from file for quick access. Instantiated when needed, the image can be blasted away.
 * This is stored here to limit memory usage in a string intensive program that already eats 750 mb of ram on average
 * 
 * @author asevans
 *
 */
